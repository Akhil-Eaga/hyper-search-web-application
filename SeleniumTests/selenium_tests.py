...
class TestApp():
  ...
  def test_adminLogout(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "p").text == "Be a better Googler!*"
  ...
  def test_userExcerices(self):
    ...
    assert len(elements) == 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".button-container:nth-child(4) > .btn:nth-child(1)")
    assert len(elements) > 0
  ...
  def test_userQuiz(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".btn").click()
    self.driver.find_element(By.LINK_TEXT, "Quiz").click()
    self.driver.find_element(By.CSS_SELECTOR, ".button-container:nth-child(4) > .btn:nth-child(1)").click()
    self.driver.find_element(By.ID, "2").click()
    self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").click()
    ...
    self.driver.find_element(By.ID, "2").click()
    self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".result-box .btn:nth-child(1)").text == "Try Again"
    assert self.driver.find_element(By.CSS_SELECTOR, ".result-box .btn:nth-child(2)").text == "Dashboard"
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".result-box > h1")
    assert len(elements) > 0
    assert self.driver.find_element(By.CSS_SELECTOR, ".result-box > h1").text == "Quiz Result"
    self.driver.find_element(By.CSS_SELECTOR, ".result-box .btn:nth-child(1)").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".next-question-btn > .btn")
    assert len(elements) > 0
    assert self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").text == "Next"
    self.driver.find_element(By.ID, "0").click()
    self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").click()
    self.driver.find_element(By.ID, "1").click()
    self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".next-question-btn > .btn").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".result-box .btn:nth-child(2)").text == "Dashboard"
    self.driver.find_element(By.CSS_SELECTOR, ".result-box .btn:nth-child(2)").click()
